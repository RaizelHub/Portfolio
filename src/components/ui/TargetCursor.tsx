...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const strengthProxy = activeStrengthRef.current;
    ...
    const tickerFn = () => {
      ...
      const strength = strengthProxy.current;
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      const leaveHandler = () => {
        ...
        gsap.set(strengthProxy, { current: 0, overwrite: true });
        activeTarget = null;
